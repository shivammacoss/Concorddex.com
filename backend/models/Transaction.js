...
const transactionSchema = new mongoose.Schema({
  ...
  type: {
    type: String,
    enum: ['deposit', 'withdrawal', 'trade_profit', 'trade_loss', 'trade_close', 'fee', 'bonus', 'referral', 'margin_deduction', 'margin_release', 'commission', 'spread_cost', 'swap', 'transfer_in', 'transfer_out'],
    required: true
  },
  amount: {
    type: Number,
